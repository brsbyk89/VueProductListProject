      ...
      <div class="card offset-2 col-md-3">
        <div class="card-body tex-center d-flex align-items-center flex-column">
          <img height="128" class="img-responsive text-center mb-3"
               :src="product.selectedImage == null ? '/default.png' : product.selectedImage">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control" placeholder="adetini giriniz" v-model="product.count">
              </div>
              <div class="form-group col-md-6">
                <label>Ürün Fiyatı</label>
                <input type="number" class="form-control" placeholder="fiyatını giriniz" v-model="product.price">
              </div>
            </div>
...
export default {
      ...
      addproduct(){
        ...
        eventBus.$emit("productfromeventbus",this.product);
        eventBus.$emit("productcount",this.clickedcount);
